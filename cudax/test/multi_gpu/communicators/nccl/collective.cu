...
MGMN_TEST("nccl_communicator_ref all_reduce sum", )
{
...
MGMN_TEST("nccl_communicator_ref all_reduce maximum", )
{
  auto streams = nccl_test_util::make_streams();
...
MGMN_TEST("nccl_communicator_ref reduce sum to root 0", )
{
  auto streams = nccl_test_util::make_streams();
...
MGMN_TEST("nccl_communicator_ref broadcast from root 0", )
{
  auto streams = nccl_test_util::make_streams();
...
MGMN_TEST("nccl_communicator_ref all_gather", )
{
  auto streams = nccl_test_util::make_streams();
...
MGMN_TEST("nccl_communicator_ref gather_v to root 0", )
{
  auto streams = nccl_test_util::make_streams();
...
MGMN_TEST("nccl_communicator_ref all_to_all_v", )
{
  auto streams = nccl_test_util::make_streams();
...
MGMN_TEST("nccl_communicator_ref all_to_all", )
{
  auto streams = nccl_test_util::make_streams();
