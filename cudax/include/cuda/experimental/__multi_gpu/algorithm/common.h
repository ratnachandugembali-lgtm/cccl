  ...
  ::cuda::stream_ref __stream, _Resource __resource, ::cuda::std::size_t __size, const _Env& __env)
{
  ...
  {
    return ::cuda::make_buffer<_Tp>(__stream, ::cuda::std::move(__resource), __size, ::cuda::no_init, __env);
  }
  else
  {
    return ::cuda::make_buffer<_Tp>(__stream, ::cuda::std::move(__resource), __size, _Tp{}, __env);
  }
}
