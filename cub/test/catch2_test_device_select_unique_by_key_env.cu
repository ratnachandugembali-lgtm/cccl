...
using all_types = c2h::type_list<int, c2h::custom_type_t<c2h::equal_comparable_t>>;

using integral_types = c2h::type_list<std::uint8_t, std::uint16_t, std::uint32_t, std::uint64_t, int>;
