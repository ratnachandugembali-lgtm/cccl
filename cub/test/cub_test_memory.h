...
#define CUB_TEST_MEMORY_CLASS_IMPL(MEMORY_CLASS) CUB_TEST_MEMORY_CLASS_##MEMORY_CLASS
#define CUB_TEST_MEMORY_CLASS(MEMORY_CLASS)      CUB_TEST_MEMORY_CLASS_IMPL(MEMORY_CLASS)
