...
struct DeviceSelect
{
  ...
  // We cannot simply use `indirect_binary_predicate` because it fails with zipped device_pointers
  template <typename KeyInputIteratorT, typename NumItemsT, typename EnvT, typename EqualityOpT = ::cuda::std::equal_to<>>
  static constexpr bool __is_valid_unique_by_key =
    ::cuda::std::is_integral_v<NumItemsT>
    && ::cuda::std::predicate<EqualityOpT, detail::it_value_t<KeyInputIteratorT>, detail::it_value_t<KeyInputIteratorT>>
    && !::cuda::std::predicate<EnvT, detail::it_value_t<KeyInputIteratorT>, detail::it_value_t<KeyInputIteratorT>>;
  ...
  template <typename KeyInputIteratorT,
            ...
            typename EqualityOpT,
            typename EnvT = ::cuda::std::execution::env<>,
            ::cuda::std::enable_if_t<__is_valid_unique_by_key<KeyInputIteratorT, NumItemsT, EnvT, EqualityOpT>, int> = 0>
  ...
  template <typename KeyInputIteratorT,
            ...
            typename NumItemsT,
            typename EnvT = ::cuda::std::execution::env<>,
            ::cuda::std::enable_if_t<__is_valid_unique_by_key<KeyInputIteratorT, NumItemsT, EnvT>, int> = 0>
  [[nodiscard]] CUB_RUNTIME_FUNCTION _CCCL_FORCEINLINE static cudaError_t UniqueByKey(
    KeyInputIteratorT d_keys_in,
    ValueInputIteratorT d_values_in,
    KeyOutputIteratorT d_keys_out,
